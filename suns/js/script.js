	  ...
	  $(function () {
	    ...
	    $('.shop-featured').each(function(){
		  	...
		  	$(this).find('input[type="radio"]').prop('checked', false);  
				...
				TweenMax.set(the_frame, {drawSVG:"0%", stroke: "#E93382"});
				TweenMax.set(the_glass, {drawSVG:"0%", stroke: "#FFFFFF"});
		    ...
		    // Show just the frame
				the_svg.on('mouseover touchstart', function(){		

					TweenMax.to(this_product.find(".fotorama-shop"), 1, {opacity: 1});
					TweenMax.to(the_frame, 2, {drawSVG:"100%"});
					TweenMax.to(the_glass, 2, {drawSVG:"100%"});	
					TweenMax.to(the_frame, 2, {drawSVG:"0%", delay: 3});
					TweenMax.to(the_glass, 2, {drawSVG:"0%", delay: 3});	
		    })
		    
		    the_svg.on('mouseout touchend', function(){
					if(!this_product.hasClass("triggered")) {	
						//TweenMax.to(this_product.find(".fotorama-shop"), 1, {opacity: 0});
						TweenMax.to(the_frame, 1, {drawSVG:"0%"});
						TweenMax.to(the_glass, 1, {drawSVG:"0%"});	
				  }  
		    }); 		    		    
